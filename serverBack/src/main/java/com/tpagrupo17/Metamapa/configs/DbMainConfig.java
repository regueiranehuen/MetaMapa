...
@EnableJpaRepositories(
        basePackages = "com.tpagrupo17.Metamapa.repositories.DbMain",
...
public class DbMainConfig {
    ...
    public LocalContainerEntityManagerFactoryBean mainEntityManagerFactory(
        ...
        return builder
                .dataSource(ds)
                .packages("com.tpagrupo17.Metamapa.entities.DbMain", "com.tpagrupo17.Metamapa.entities.atributosHecho")
                .persistenceUnit("db4")
                .properties(jpaProps)
                .build();
    }
