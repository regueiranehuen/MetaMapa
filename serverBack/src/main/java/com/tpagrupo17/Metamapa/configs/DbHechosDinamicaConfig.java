...
@EnableJpaRepositories(
        basePackages = "com.tpagrupo17.Metamapa.repositories.DbDinamica",
...
public class DbHechosDinamicaConfig {
    ...
    public LocalContainerEntityManagerFactoryBean dinamicaEntityManagerFactory(
        ...
        return builder
                .dataSource(ds)
                .packages("com.tpagrupo17.Metamapa.entities.DbDinamica",
                        "com.tpagrupo17.Metamapa.entities.atributosHecho")
                .persistenceUnit("db2")
                .properties(jpaProps)
                .build();
    }
